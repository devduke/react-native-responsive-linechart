    ...
    return (React.createElement(React.Fragment, null,
        ...
        finalTickValues.map(function (value) {
            return (React.createElement(React.Fragment, { key: value },
                ...
                labels.visible && (React.createElement(react_native_svg_1.G, { translateX: labels.label.dx + dimensions.width, translateY: labels.label.dy + utils_1.scalePointToDimensions({ x: 0, y: value }, viewportDomain, dimensions).y },
                    React.createElement(react_native_svg_1.ForeignObject, { x: 0, y: 0 },
